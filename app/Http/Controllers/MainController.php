...
class MainController extends Controller
{
    ...
    public function quiz($slug){
        $quiz = Quiz::whereSlug($slug)->with('questions.my_answer')->first() ?? abort(404);
    ...
    public function quiz_detail($slug){
        $quiz = Quiz::whereSlug($slug)->with('my_result','topTen.user')->withCount('questions')->first() ?? abort();
    ...
    public function result(Request $request, $slug){
        ...
        return redirect()->route('quiz.detail',$quiz->slug)->withSuccess('The quiz was successfully completed. Point: '.$point);
    }
}
